...
DATABASES = {
    'default': {
        ...
        'NAME': 'hobby',                      # Or path to database file if using sqlite3.
...
FACEBOOK_APP_ID = '213824942077129'
FACEBOOK_APP_SECRET = 'd06da133582bae47f62245e532685cef'
FACEBOOOK_REDIRECT_URI = 'http://creeply.dev:8000/facebook/login/?connect_facebook=1'
...
STATICFILES_DIRS = (
    '/Users/nahimnasser/Documents/code/hobby/creeply/templates/static',
...
SECRET_KEY = '4*wp8@-i*!8*uw%jmy#zt5kd)#fouz@b1@k=w018$ws=i&amp;)5ju'
